...
var _moveX = function (obj, xRange, time = 0) {
    setTimeout(() => obj.dom.style.left = parseInt(obj.dom.style.left.slice(0, -2)) + xRange,
        time)
}

var _moveY = function (obj, yRange, time = 0) {
    setTimeout(() => obj.dom.style.top = parseInt(obj.dom.style.top.slice(0, -2)) + yRange,
        time)
}
...
var _fadeOut = function (object, time, opacity = 0) {
    object.dom.classList.add("unclickable")
    setTimeout(function () {
        object.dom.classList.add("fader");
        object.dom.style.opacity = opacity;
        setTimeout(function () {
            object.dom.classList.remove("fader");
        }, 500);
    }, time);
