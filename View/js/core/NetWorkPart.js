...
function NWP(config) {
    ...
    self.setInForeGround = function () {
        self.dom.style.opacity = "" + 1;
    };
    self.setInBackGround = function () {
        self.dom.style.opacity = "" + backgroundOpacity;
    };
    ...
    self.activate = function (activeNWPs) {
        self.dom.style.opacity = "" + (activeNWPs.includes(self.id) ? 1.0 : backgroundOpacity);
